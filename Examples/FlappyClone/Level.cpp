...
void Level::OnRender()
{
	...
	Lust::Renderer2D::DrawQuad(Lust::vec2{ playerPos.x(), -floorDistance }, Lust::vec2{ 50.0f, 50.0f }, { controllerInfo, texCoordsEdges, Lust::uvec4(0xffffffff,0xffffffff,0xffffffff,0xffffffff) }, false);
	Lust::Renderer2D::DrawQuad(Lust::vec2{ playerPos.x(), floorDistance }, Lust::vec2{ 50.0f, 50.0f }, { controllerInfo, texCoordsEdges, Lust::uvec4(0xffffffff,0xffffffff,0xffffffff,0xffffffff) }, false);

	for (auto& pillar : m_Pillars)
	{
		Lust::Renderer2D::DrawQuad(pillar.TopPosition, pillar.TopScale, Lust::Radians(180.0f), { pillarControllerInfo, texCoordsEdges, Lust::uvec4(0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff) }, false);
		Lust::Renderer2D::DrawQuad(pillar.BottomPosition, pillar.BottomScale, 0.0f, { pillarControllerInfo, texCoordsEdges, Lust::uvec4(0xffffffff,0xffffffff,0xffffffff,0xffffffff) }, false);
	}
